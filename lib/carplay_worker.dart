...
class FlutterCarplay {
  ...
  static Future<bool> setNowPlayingButtons(
    ...
    // Skip updates that would not change the rendered buttons. The
    // configuration excludes element ids, which are regenerated on every
    // button construction.
  ...
  static Future<bool> updateNowPlayingShuffleState({
    ...
    final bool? isCompleted = await _carPlayController.methodChannel
        .invokeMethod<bool>('updateNowPlayingShuffleState', isShuffled);
    return isCompleted ?? false;
  }
