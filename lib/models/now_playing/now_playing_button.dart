...
///
/// The system handles the visual state and automatically cycles through the
/// available repeat modes (off, one, all) on tap.
...
///
/// The system handles the visual state; CarPlay reads it from
/// `MPRemoteCommandCenter.changeShuffleModeCommand.currentShuffleType`, so
/// call [FlutterCarplay.updateNowPlayingShuffleState] whenever your app's
...
///
/// The system handles the visual state and automatically cycles through the
/// available playback rates on tap.
